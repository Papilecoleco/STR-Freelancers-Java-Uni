...
public class PaginaInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(400, 380, 260, 40);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        uti.setUsername("Admin");
        uti.setPassword("Admin");
        uti.setEmail("Admin");
        uti.setNome("Admin");
        uti.setHorasTrabalho(10);
        uti.setTipo(TipoConta.ADMIN);
        

        Repositorio.getInstance().novoUtilizador(uti);
        //Lê o Repositório
        Repositorio.desserializar("repositorio");
