...
public class NovoProjeto extends javax.swing.JPanel {
     ...
     */
    public NovoProjeto(PaginaInicial parent, String user) {
        initComponents();
        parentFrame = parent;
        ...
        //Inicializa a tabela com as tarefas no repositorio
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(220, 580, 200, 40);
        ...
        jPanel1.add(jLabel9);
        jLabel9.setBounds(200, 150, 170, 27);

        txtNome.setBackground(new java.awt.Color(204, 204, 204));
        jPanel1.add(txtNome);
        txtNome.setBounds(200, 180, 560, 30);
        ...
        jLabel12.setBounds(210, 360, 170, 30);
        ...
        jScrollPane1.setBounds(200, 390, 560, 150);
        ...
        jButton5.setBounds(590, 580, 170, 40);
        ...
        jLabel13.setBounds(200, 210, 170, 27);
        ...
        txtNomeCliente.setBounds(200, 240, 560, 30);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        //Variaveis
        //Um Projeto Recebe um projeto uma lista utilizadores e uma lista de tarefas
        ...
        //Coleções
        Set<Tarefas> tarefaList = new HashSet<>();
        Set<Utilizador> UtilizadorList = new HashSet<>();

        //Nova Tarefa
        Tarefas tarefa = new Tarefas();
        tarefa.setDescricao(n);
        ...
        proj.setTarefaList(tarefaList);
        proj.setUtil(UtilizadorList);
        proj.setNomeCliente(NomeCliente);

        //adiciona novo Projeto ao Repositorio
        Repositorio.getInstance().novoProjetoTarefa(proj, tarefaList);
        JOptionPane.showMessageDialog(null, "Novo Projeto Criado!");
